...
{!! Form::open(['action' => ['PlaceController@update',  $place->id], 
'method' => 'patch', 
                ...
                <div class="x_content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::text('title', $place->title, ['id'=>'title', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder' => 'Ex: Auckland harbour...']) !!}
                            @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::text('abbreviation',  $place->abbreviation, ['id'=>'abbreviation', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder' => 'Ex: AKL']) !!}
                            @error('abbreviation')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::select('type', ['sea'=> 'Sea','air'=>'Air'], $place->type, ['id'=>'type', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder' => 'Ex: Sea or Air...']) !!}
                            @error('type')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
...
<div class="form-group">
    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
        {!! Form::submit('Update place', ['class' => 'btn btn-success triggerOverlay']) !!}
        <br /><br /><br />           
    </div>
</div>
