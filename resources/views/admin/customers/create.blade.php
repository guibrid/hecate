            ...
            <div class="x_content">
                ...
                <div class="x_content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::text('cp', null, ['id'=>'cp', 'class'=>'form-control col-md-7 col-xs-12']) !!}
                            @error('cp')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::select('country', config('variables.form.countries'), null, ['placeholder' => 'Select country...','id' => 'country', 'class' => 'form-control col-md-7 col-xs-12']) !!}
                            @error('country')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
